...
class RedisHealthManager:
    ...
    def store_health_data(
        ...
        try:
            ...
            raise ToolError(f"Redis storage failed: {str(e)}", "REDIS_ERROR")
    ...
    def query_health_metrics(
        ...
        try:
            ...
            raise ToolError(f"Redis query failed: {str(e)}", "REDIS_ERROR")
    ...
    def cleanup_expired_data(self, user_id: str) -> dict[str, Any]:
        ...
        try:
            ...
            raise ToolError(f"Redis cleanup check failed: {str(e)}", "REDIS_ERROR")
