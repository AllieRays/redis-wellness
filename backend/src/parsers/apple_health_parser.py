...
class AppleHealthParser:
    ...
    def parse_file(
        ...
        try:
            ...
            raise ParsingError(f"Failed to parse health data: {sanitized_message}")
    ...
    def _validate_file_path(self, file_path: str) -> None:
        ...
        try:
            ...
            raise ParsingError("Invalid file path format")
    ...
    def _parse_xml_securely(
        ...
        try:
            ...
            health_data = HealthDataCollection(
                export_date=datetime.now(), record_count=0
            )
            ...
            raise ParsingError("Invalid XML format")
        except ExpatError:
            raise ParsingError("XML parsing error")
        except MemoryError:
            raise ParsingError("File too large for available memory")
