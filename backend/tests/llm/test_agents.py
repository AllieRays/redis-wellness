...
class TestStatelessAgent:
    ...
    async def test_stateless_agent_basic_response(self, stateless_agent, test_user_id):
    ...
    async def test_stateless_agent_tool_calling(self, stateless_agent, test_user_id):
...
class TestAgentResponseQuality:
    ...
    async def test_agent_generates_non_empty_response(
        self, stateless_agent, test_user_id
    ):
    ...
    async def test_agent_response_time_reasonable(self, stateless_agent, test_user_id):
